 ...
 */
public enum StandardUnitPrefixes implements UnitPrefixes {
    METRIC("Metric", new MetricPrefixFormatter()),
    BINARY("Binary", new BinaryPrefixFormatter());

    private String label;
    private PrefixFormatter formatter;

    StandardUnitPrefixes(String label, PrefixFormatter formatter) {
        this.label = label;
    ...
    @Override
    public PrefixFormatter getFormatter() {
        return formatter;
    }
